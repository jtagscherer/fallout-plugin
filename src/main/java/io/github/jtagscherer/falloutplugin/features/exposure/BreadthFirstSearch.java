...
class BreadthFirstSearch {
    ...
    private void maybeAddLocationToQueue(Queue<DistancedLocation> queue, Set<DistancedLocation> visitedDistancedLocations, DistancedLocation oldDistancedLocation, int x, int y, int z) {
        ...
        if (blockMaterial.isOccluding() || this.isGlassBlock(blockMaterial) || this.isGlassPane(blockMaterial) || blockMaterial == Material.FARMLAND) {
            return;
        }
    ...
    private boolean isGlassPane(Material blockMaterial) {
        return blockMaterial == Material.GLASS_PANE || blockMaterial == Material.WHITE_STAINED_GLASS_PANE
                || blockMaterial == Material.ORANGE_STAINED_GLASS_PANE || blockMaterial == Material.MAGENTA_STAINED_GLASS_PANE
                || blockMaterial == Material.LIGHT_BLUE_STAINED_GLASS_PANE || blockMaterial == Material.YELLOW_STAINED_GLASS_PANE
                || blockMaterial == Material.LIME_STAINED_GLASS_PANE || blockMaterial == Material.PINK_STAINED_GLASS_PANE
                || blockMaterial == Material.GRAY_STAINED_GLASS_PANE || blockMaterial == Material.LIGHT_GRAY_STAINED_GLASS_PANE
                || blockMaterial == Material.CYAN_STAINED_GLASS_PANE || blockMaterial == Material.PURPLE_STAINED_GLASS_PANE
                || blockMaterial == Material.BLUE_STAINED_GLASS_PANE || blockMaterial == Material.BROWN_STAINED_GLASS_PANE
                || blockMaterial == Material.GREEN_STAINED_GLASS_PANE || blockMaterial == Material.RED_STAINED_GLASS_PANE
                || blockMaterial == Material.BLACK_STAINED_GLASS_PANE;
    }
